...
if (!class_exists('Plugin_Options_Framework_0_2_4')){
	class Plugin_Options_Framework_0_2_4{
		...
		function __construct($plugin_file, $fields = array(), $options = array()){
			...
			$this->renderer = isset($options['fields']) ? new $options['fields']($this) : new Plugin_Options_Framework_Fields_0_2_4($this);
...
if (!class_exists('Plugin_Options_Framework_Fields_0_2_4')){
	class Plugin_Options_Framework_Fields_0_2_4{
		var $pof;
		var $h;
